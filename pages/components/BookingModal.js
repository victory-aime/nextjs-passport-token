        ...
        <section id="booking-modal">
            <div className="bg-black/70 fixed inset-0 z-40">
                <div className="absolute bg-white inset-y-0 inset-x-0 lg:inset-y-16 lg:inset-x-80 z-50 overflow-y-auto">
                    <div className="bg-custom-blue flex items-center justify-between text-white text-2xl p-4 font-bold">
                    ...
                    <div className="bg-custom-pink p-4 space-y-4">
                        <div className="text-custom-blue flex items-center gap-2">
                ...
                Upon completing this reservation enquiry, you will receive:
                  ...
                  <span className="text-lg">
                    ...
                    <div className="px-8 py-10 space-y-8">
                        <div>
                            <h1 className="font-bold text-custom-blue text-lg">
                    ...
                    This field is required.
                        ...
                        <div className="lg:flex lg:justify-end">
                            <button
                                className="bg-custom-blue w-full lg:w-fit shadow-orange-bottom hover:shadow-orange-bottom-hov transition-all duration-300 ease-linear text-white p-3 font-bold rounded"
                                onClick={() => {
